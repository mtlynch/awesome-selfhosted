...
- [LogPaste](https://github.com/mtlynch/logpaste) - Minimal pastebin web app that's easy to self-host and persists data to any S3-compatible backend. ([Demo](http://logpaste.com/), [Source Code](https://github.com/mtlynch/logpaste)) `MIT` `Go` `Docker`
